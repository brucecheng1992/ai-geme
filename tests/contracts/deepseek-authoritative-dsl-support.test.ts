...
describe('DeepSeek authoritative DSL support vocabulary', () => {
  ...
  it('registers artifact lineage no-manual-patch as package-backed but still incomplete support', () => {
    ...
    expect(capabilities.get('runtime.manifest_binding.v1')).toMatchObject({
      registered: true,
      classification: 'DEFERRED',
      completeSupported: false,
      legacyBacked: false,
    ...
    expect(capabilities.get('runtime.module_load_receipt.v1')).toMatchObject({
      registered: true,
      classification: 'DEFERRED',
      completeSupported: false,
      legacyBacked: false,
    ...
    expect(capabilities.get('scene.ordered_segments.v1')).toMatchObject({
      registered: true,
      classification: 'DEFERRED',
      completeSupported: false,
      legacyBacked: false,
