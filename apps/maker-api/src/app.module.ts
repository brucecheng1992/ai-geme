...
import { ArtAssetPreviewModule } from './art-asset-preview/art-asset-preview.module.js';
...
@Module({
  imports: [LocalWorkspaceModule, ProjectsModule, ModelProviderModule, CompilerModule, QaModule, RepairModule, ArtAssetPreviewModule],
